...
export default function CatFactory(props) {
    return (
        <Col lg={7}>
            ...
            <div>
                <Button variant="warning" className="m-2">Default Kitty</Button>
                <Button variant="warning" className="m-2">Random Kitty</Button>
                <Button variant="warning" className="m-2">Create Kitty</Button>
            </div>
        </Col>
    )
}
